...
*/
    ...
    Redux::setSection( $opt_name,array(
            ...
            'fields'   => array(array(
                    ...
                    'url'   => true,
                    'default'=> array(
                            'url' => get_template_directory_uri().'/assets/icon/favicon.ico'
                        )
                ))
        ));
    Redux::setSection( $opt_name,array(
            'title' => __('Appointment Area','spa'),
            'id'    => 'for_appointment',
            'desc'  => 'This is for Appointment Area',
            'icon'  => 'el el-address-book'
        ));
    Redux::setSection( $opt_name,array(
            'title' => __('Make an Appointment','spa'),
            'id'    => 'appointment',
            'subsection' => true,
            'fields' => array(array(
                'id' => 'appointment_field',
                'title' => 'Appointment Area Editor',
                'desc' => 'Edit Appointment Area',
                'type' => 'editor',
                'default' => '<h3>Book A Session Now</h3>
                    <p><i class="fa fa-phone"></i> <span>Call Us at</span> 0785 6985 636</p>
                    <p><strong>or</strong></p>
                    <p><i class="fa fa-envelope-o"></i> <span>Send us an email:</span> hey@ygritte.com</p>',

                )
                )
        ));
    Redux::setSection( $opt_name,array(
            'title'    => __('Footer Options','spa'),
            'id'       => 'footer_option',
    ...
    Redux::setSection( $opt_name,array(
            'title' => __('Contact Page Option','spa'),
            'id'    => 'contact_page_option',
            'desc'  => 'This is Contact Page Option',
            'icon'  => 'el el-address-book'
        ));
    Redux::setSection( $opt_name,array(
            'title' => __('Address Map','spa'),
            'id'    => 'address_map',
            'subsection' => true,
            'fields' => array(array(
                'id' => 'map_url',
    ...
    Redux::setSection( $opt_name,array(
            'title' => __('Section Sorter','spa'),
            'id'    => 'section_sorter',
            'desc'  => 'Sort you Section Here',
            'icon'  => 'el el-certificate'
        ));
    Redux::setSection( $opt_name,array(
            'title' => __('Section Sorter Option','spa'),
    ...
    Redux::setSection( $opt_name,array(
            'title' => __('Appearance','spa'),
            'id'    => 'appearance_option',
            'icon'  => 'el el-magic'
        ));
    Redux::setSection( $opt_name,array(
            'title' => __('Footer Top','spa'),
            'id'    => 'footer_top',
            'subsection' => true,
            'fields' => array(array(
                'id' => 'footer_top_bg',
